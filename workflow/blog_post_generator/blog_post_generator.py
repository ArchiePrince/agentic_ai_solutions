# Title of Project: Blog Post Generator
# Author: Archie Prince
# Filename: finance_agent.py
# Date: 31.12.2024
# Objective: To Create a blog post generator that can search the web, read the top links and write a blog post for us. We’ll cache intermediate results in the database to improve performance.
